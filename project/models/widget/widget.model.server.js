...
module.exports = function () {
    ...
    var ProjWidget = mongoose.model("ProjWidget", WidgetSchema);
    ...
    function createWidget(pageId, widget) {
        widget._page = pageId;
        return ProjWidget.create(widget);
    }

    function findAllWidgetsForPage(pageId) {
        return ProjWidget.find({_page: pageId});
    }

    function findWidgetById(widgetId) {
        return ProjWidget.findById(widgetId);
    }

    function updateWidget(widgetId, widget) {
        return ProjWidget.update(
            {_id: widgetId},
            {
                $set: {
    ...
    function deleteWidget(widgetId) {
        return ProjWidget.remove({_id: widgetId});
    }
